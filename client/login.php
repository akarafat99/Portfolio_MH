...
$session::destroy();
$session::ensureSessionStarted(); // Ensure the session is started
...
if (isset($_POST['signin'])) {
    ...
    $result = $user->checkUserEmailWithStatus($email, $password, "client");
    if($result[0] == "1"){
        $session::set("user", "client");
        $session::set("user_id", $user->user_id);
        $session::storeObject("user_obj", $user);
                    ...
                    <div class="col-lg-6">
                        <div class="signup-form-wrapper">
                            <div class="section-title text-center mb-5">
                                <?php
                                if ($session::get("msg1")) {
                                    echo '<div class="alert alert-danger" role="alert">' . $session::get("msg1") . '</div>';
                                    $session::delete("msg1");
                                }
                                ?>
                            ...
                            <form id="loginForm" action="" method="POST">
                                ...
                                <div class="forgot-password-wrapper">
                                    <a href="forgot-password-1.php" class="forgot-password">Forgot Password?</a>
                                </div>
                                <div class="submit-btn-wrapper">
                                    <button class="signup-btn btn-1" type="submit" name="signin">Sign In</button>
                                </div>
