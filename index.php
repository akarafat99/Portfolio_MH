        ...
        <div class="hero-intro-content-wrapper">
          ...
          <div class="social-wrapper">
            ...
            <div class="social-icon-wrap">
              <a href="https://www.facebook.com/halder.shanker" target="_blank" class="social-link">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="https://github.com/monishankerhalder" target="_blank" class="social-link">
                <i class="fab fa-github"></i>
              </a>
              <a href="https://scholar.google.com/citations?user=z1Fj-dMAAAAJ&hl=en" target="_blank" class="social-link">
                <i class="fas fa-graduation-cap"></i>
              </a>
              <a href="https://just.edu.bd/t/monishanker" target="_blank" class="social-link">
                <i class="fas fa-university"></i>
              </a>
              <a href="https://www.linkedin.com/in/monishanker-halder-645087100/" target="_blank" class="social-link">
    ...
    <div class="container">
      <div class="contact-contents-wrapper">
        <div class="contact-heading-wrapper">
          ...
          <a role="listitem" aria-label="Facebook profile" class="social-btn facebook" href="https://www.facebook.com/halder.shanker" target="_blank" rel="noopener noreferrer">
            <i class="fab fa-facebook-f" aria-hidden="true"></i>
          </a>
          <a role="listitem" aria-label="GitHub profile" class="social-btn github" href="https://github.com/monishankerhalder" target="_blank" rel="noopener noreferrer">
            <i class="fab fa-github" aria-hidden="true"></i>
          </a>
          <a role="listitem" aria-label="Google Scholar" class="social-btn scholar" href="https://scholar.google.com/citations?user=z1Fj-dMAAAAJ&hl=en" target="_blank" rel="noopener noreferrer">
            <i class="fas fa-graduation-cap" aria-hidden="true"></i>
          </a>
          <a role="listitem" aria-label="University profile" class="social-btn university" href="https://just.edu.bd/t/monishanker" target="_blank" rel="noopener noreferrer">
            <i class="fas fa-university" aria-hidden="true"></i>
          </a>
          <a role="listitem" aria-label="LinkedIn profile" class="social-btn linkedin" href="https://www.linkedin.com/in/monishanker-halder-645087100/" target="_blank" rel="noopener noreferrer">
          ...
          <div class="contact-card">
            ...
            <div class="contact-address-content-wrap">
              ...
              <div class="contact-address-link-wrap">
                <a href="tel:+8801712345678" class="contact-address-link">+880 1674227797</a>
              </div>
            </div>
          </div>
          <div class="contact-card">
            ...
            <div class="contact-address-content-wrap">
              <h3>Email</h3>
              <div class="contact-address-link-wrap">
                <a href="mailto:m.halder@just.edu.bd" class="contact-address-link">m.halder@just.edu.bd</a>
              </div>
            </div>
          </div>
          <div class="contact-card">
            ...
            <div class="contact-address-content-wrap">
              <h3>Email</h3>
              <div class="contact-address-link-wrap">
                <a href="mailto:monicsejust@gmail.com" class="contact-address-link">monicsejust@gmail.com</a>
              </div>
            </div>
          </div>
          <div class="contact-card">
